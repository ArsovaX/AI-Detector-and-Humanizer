#!/usr/bin/env node
// smoke.mjs — Lightweight smoke tests for TextForge AI engines
...
// Texts that share only a tiny phrase
...
// Tiny overlap should not spike score
...
// Run humanizer multiple times to catch stochastic bugs
